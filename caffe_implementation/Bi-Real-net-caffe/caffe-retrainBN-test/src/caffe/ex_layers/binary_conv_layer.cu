...
template <typename Dtype>
void BinaryConvolutionLayer<Dtype>::ModifyGradientsGPUTo(const shared_ptr<Blob<Dtype> > dw_b, const shared_ptr<Blob<Dtype> > w_r, const shared_ptr<Blob<Dtype> > dw_r) {
...
template void BinaryConvolutionLayer<float>::ModifyGradientsGPUTo(const shared_ptr<Blob<float> > weights, const shared_ptr<Blob<float> > w_r, const shared_ptr<Blob<float> > wb);
template void BinaryConvolutionLayer<double>::ModifyGradientsGPUTo(const shared_ptr<Blob<double> > weights, const shared_ptr<Blob<double> > w_r, const shared_ptr<Blob<double> > wb);
